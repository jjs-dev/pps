...
use valuer_api::{
    JudgeLog, JudgeLogKind, ProblemInfo, Status, SubtaskVisibleComponents, TestVisibleComponents,
};
...
impl Fiber {
    ...
    pub(crate) fn add(&mut self, notification: &valuer_api::TestDoneNotification) {
